...
@Component({
  selector: 'app-preparation-grid',
  templateUrl: './preparation-grid.component.html',
  styleUrls: ['./preparation-grid.component.css']
})
export class PreparationGridComponent implements OnInit {
